...
def globalAlignment(x, y):
    """
    This function calculates the edit distance matrix using penalty scores.
    Transitions (2): (Two-ring purines) A --> G and (One-ring pyrimidines) C --> T
    Transversions (4): Purines --> Pyrimidines
    Skips (8)
    """
    alphabet = ['A', 'C', 'G', 'T']
